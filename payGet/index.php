...
<body>
    ...
    <footer class="footer bg-light p-4 text-center">
        PayPage - 1.3.0 - <small class="text-muted"> PHP ready to use Payment Gateway Integrations</small> Design & Developed by <a href="https://livelyworks.net">LivelyWorks</a>
    </footer>
</body>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#lwPaymentForm').on('submit', function(e){ 
            ...
            if (paymentOption == 'paypal' || paymentOption == 'paytm' || paymentOption == 'instamojo' || paymentOption == 'iyzico' || paymentOption == 'authorize-net' || paymentOption == 'bitpay' || paymentOption == 'mercadopago') {
